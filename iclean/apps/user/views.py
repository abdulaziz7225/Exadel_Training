...
from apps.user.permissions import IsStaffOrReadOnly, IsStaff, IsClientUser, IsCompanyUser, IsClient, IsCompany 
...
class CompanyViewSet(viewsets.ModelViewSet):
    ...
    #     instance = self.get_object_or_404(Company, pk=pk)
    #     serializer = self.get_serializer(instance)
    #     return Response(serializer.data)
